...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ModifyRatingTable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ModifyRatingTable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201311111422557_ModifyRatingTable"
            End Get
        End Property
