...
Namespace Migrations
    ...
    Public NotInheritable Partial Class FixIngredientAmountToDouble
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FixIngredientAmountToDouble))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201310221817581_FixIngredientAmountToDouble"
            End Get
        End Property
