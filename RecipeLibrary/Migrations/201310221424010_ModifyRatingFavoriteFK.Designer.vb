...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ModifyRatingFavoriteFK
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ModifyRatingFavoriteFK))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201310221424010_ModifyRatingFavoriteFK"
            End Get
        End Property
