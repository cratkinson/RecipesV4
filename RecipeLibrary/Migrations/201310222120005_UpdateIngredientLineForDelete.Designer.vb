...
Namespace Migrations
    ...
    Public NotInheritable Partial Class UpdateIngredientLineForDelete
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UpdateIngredientLineForDelete))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201310222120005_UpdateIngredientLineForDelete"
            End Get
        End Property
