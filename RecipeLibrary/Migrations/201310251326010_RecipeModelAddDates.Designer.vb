...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RecipeModelAddDates
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RecipeModelAddDates))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201310251326010_RecipeModelAddDates"
            End Get
        End Property
