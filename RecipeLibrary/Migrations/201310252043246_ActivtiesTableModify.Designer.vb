...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ActivtiesTableModify
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ActivtiesTableModify))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201310252043246_ActivtiesTableModify"
            End Get
        End Property
