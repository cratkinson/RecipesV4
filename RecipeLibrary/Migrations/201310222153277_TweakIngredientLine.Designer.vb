...
Namespace Migrations
    ...
    Public NotInheritable Partial Class TweakIngredientLine
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TweakIngredientLine))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201310222153277_TweakIngredientLine"
            End Get
        End Property
